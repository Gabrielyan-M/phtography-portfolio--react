import Nav from "../head/navigations"


function Footer () {
    return (
        <section className="footer-block">
            <div className="footer-container center-column">
                <p>Моя цель — чтобы каждая фотосессия оставляла не только красивые кадры, но и тёплые воспоминания.</p>
                <div className="logo">
